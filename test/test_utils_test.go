...
type (
	...
	ConfigAndClientSuiteBase struct {
		...
		// created through newClient. Config is reapplied for the overlapping
...
func (ts *ConfigAndClientSuiteBase) newClient(clientOpts ...ConfigureClientOptions) (client.Client, error) {
	return client.Dial(ts.newClientOptions(clientOpts...))
}

func (ts *ConfigAndClientSuiteBase) newClientOptions(clientOpts ...ConfigureClientOptions) client.Options {
