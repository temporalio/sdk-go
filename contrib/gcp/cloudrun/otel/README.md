...
Stop every worker and close the Temporal client before shutting down the plugin. The following shape reserves time for telemetry within Cloud Run's roughly ten-second termination window:
