...
func NewScopeInterceptor(scope tally.Scope) *ScopeInterceptor {
	return &ScopeInterceptor{scope: scope, childScopes: make(map[string]tally.Scope)}
}
...
func (w *ScopeInterceptor) Interceptor() grpc.UnaryClientInterceptor {
	return func(ctx context.Context, method string, req, reply interface{}, cc *grpc.ClientConn, invoker grpc.UnaryInvoker, opts ...grpc.CallOption) error {
		scope := w.getOperationScope(method)
