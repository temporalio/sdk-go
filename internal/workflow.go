...
// GoNamed creates a new coroutine in workflow code, with a given human-readable name.
// It has similar semantics to native goroutines, which must not be used in workflow code.
// Name appears in stack traces that are blocked on this Channel.
//
