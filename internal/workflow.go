...
const (
	...
	// Exposed as: [go.temporal.io/sdk/workflow.ContinueAsNewSuggestedReasonTargetWorkerDeploymentVersionChanged]
	ContinueAsNewSuggestedReasonTargetWorkerDeploymentVersionChanged = 4
)
